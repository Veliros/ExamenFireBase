...
public class QuickTrade extends AppCompatActivity implements View.OnClickListener {
        ...
        bbdd.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot datasnapshot : dataSnapshot.getChildren()) {
                    ...
                    usuarios.add(new Usuario(usuario, correo, nombre, apellido, contrasenya, sDireccion, userid));
                }
                ...
                for (Usuario elemento : usuarios) {
                    ...
                    if (elemento.getId().compareTo(user.getUid()) == 0) {
                        idUsu = elemento.getUsuario();// obtenemos el Usuario loqueado
                    }
                }
                ...
                bbdd2.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot datasnapshot : dataSnapshot.getChildren()) {
                            ...
                            if (sUsuario.equals(idUsu)){
                                listadoOptions.add(sNombre);
                            }
                        }
                        adaptador = new ArrayAdapter<>(QuickTrade.this,
                                android.R.layout.simple_list_item_1,listadoOptions);
